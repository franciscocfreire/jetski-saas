...
echo "========================================="
echo "  RESET COMPLETO DO KEYCLOAK"
echo "========================================="
echo ""
echo "⚠️  ATENÇÃO: Isso vai APAGAR todos os dados do Keycloak!"
echo ""
...
echo ""
echo "=== [2/6] Dropando database Keycloak ==="
...
EOF
echo "✓ Database 'keycloak' removido"
...
echo "Aguardando 30 segundos para Keycloak inicializar completamente..."
sleep 30
...
if curl -sf http://localhost:8081/health/ready >/dev/null 2>&1; then
    ...
    echo "   Monitore: tail -f /tmp/keycloak-postgres.log"
    exit 1
fi
