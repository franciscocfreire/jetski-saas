...
# Coleta deny reasons de RBAC
deny contains msg if {
    not is_platform_admin  # Platform admin bypassa RBAC
    some msg in rbac.rbac_deny
}
...
# Platform admin com unrestricted_access bypassa todas as regras
allow if {
    is_platform_admin
}
...
deny_reasons_array := [msg | some msg in deny]
warnings_array := [msg | some msg in warnings]
...
result := {
    ...
    "deny_reasons": deny_reasons_array,
