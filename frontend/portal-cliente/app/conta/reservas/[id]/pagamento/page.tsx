          ...
          <Card className="mt-4 p-6">
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <div className="break-words text-lg font-bold text-brand-700">{brl(pg.valorSinal)}</div>
              ...
              >
                ...
                <div className="break-words text-lg font-bold text-brand-700">{brl(pg.valorTotal)}</div>
